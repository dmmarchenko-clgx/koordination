...
class InquiryService(val ttClient: TtClient) {
    ...
    suspend fun processInquiry(request: InquiryRequest): InquiryResponse {
        ...
        val saveInquiryRequest = SaveInquiryRequest(consumerMasterId, consumerDetails, address, transactionId)
        val consumerId = ttClient.saveInquiry(saveInquiryRequest)
